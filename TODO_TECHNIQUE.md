...
Aucune modification de code applicatif n'a été nécessaire pour ces deux corrections : les deux causes sont des défauts de rédaction des tests E2E de ce lot face à un comportement d'interface préexistant (fiche à onglets) et à une ambiguïté de sélecteur Playwright non liée à TODO-008. Non ré-exécutées dans cet environnement après ces corrections (registre npm bloqué), à confirmer par un nouveau passage réel du workflow GitHub Actions — **TODO-008 ne sera considéré comme définitivement clos qu'après cette confirmation**, conformément à l'instruction de Charles-Henri.
