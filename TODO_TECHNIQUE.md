...
Non ré-exécutés dans cet environnement après ces corrections (registre npm bloqué), à confirmer par un nouveau passage réel du workflow GitHub Actions — **TODO-008 ne sera considéré comme définitivement clos qu'après cette confirmation**, conformément à l'instruction de Charles-Henri.
